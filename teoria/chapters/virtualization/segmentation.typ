...
#text(9pt)[
  ...
  Seg 0 base  (grows positive): 12513
  Seg 0 limit: 290

  Seg 1 base (grows negative): 4651
  Seg 1 limit: 472

  Virtual Address Trace
    VA  0 = 507 --> VIOLATION (SEG0)
    VA  1 = 460 --> VIOLATION (SEG0)
    VA  2 = 667 --> VALID in SEG1: (4294)
    VA  3 = 807 --> VALID in SEG1: (4434)
    VA  4 = 96 --> VALID in SEG0: (12609)
  ```
]
...
+ Identificazione del segmento:
  ...
  $"bin"(507) = 01 space 1111 space 1011$\
...
+ Identificazione del segmento:
  ...
  $"bin"(460) = 01 space 1100 space 1100$\
  Il MSB è 0, quindi, il VA appartiene a Seg 0.
  Siccome $507 > 290$ l'indirizzo non è valido.
...
+ Identificazione del segmento:
  ...
  $"bin"(667) = 10 space 1001 space 1011$\
  Il MSB è 1, quindi, il VA appartiene a Seg 1.

+ Calcolo dell'offset:

  $"offset" = 472 - (1024 - 667)=115$

+ Controllo della validità dell'offset:
...
+ Identificazione del segmento:
  ...
  $"bin"(807) = 11 space 0010 space 0111$\
  Il MSB è 1, quindi, il VA appartiene a Seg 1.

+ Calcolo dell'offset:

  $"offset" = 472 - (1024 - 807)=255$
...
+ Identificazione del segmento:
  ...
  $"bin"(96) = 00 space 0110 space 0000$\
  Il MSB è 0, quindi, il VA appartiene a Seg 0.
